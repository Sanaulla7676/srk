  ...
  return (
    <section className="bg-gradient-to-r from-rkMaroon to-rkMaroonSoft font-rkSans text-white py-10">
      <div className="max-w-7xl mx-auto px-6 lg:px-14 flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <button
          onClick={goShop}
          className="inline-flex items-center gap-2.5 bg-rkCream hover:bg-white text-rkNight text-[11px] font-bold tracking-[0.15em] uppercase pl-6 pr-2 py-2 rounded-full transition-colors shrink-0"
        >
          <span>Shop Now</span>
